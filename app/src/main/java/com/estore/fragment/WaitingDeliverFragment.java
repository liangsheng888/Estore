...
public class WaitingDeliverFragment extends Fragment {
 ...
 /*	 1 待付款
    ...
    public void getData(){
        ...
        //
        RequestParams requestParams=new RequestParams(HttpUrlUtils.HTTP_URL+"orderQueryServlet?userId="+userId+"&orderStatusId=3");
        ...
        x.http().get(requestParams, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                if(orderApater==null){
                    ...
                    lv_unDeliver.setAdapter(orderApater);
                }else{
