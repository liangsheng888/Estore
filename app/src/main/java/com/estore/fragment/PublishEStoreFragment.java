...
//fragment生命周期
  ...
  final List<MyPublishActivityBean.ProImag> prolist=new ArrayList<MyPublishActivityBean.ProImag>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lv_publishlv = ((ListView) view.findViewById(R.id.lv_publishest));
        return view;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Log.i("TAG","http://10.40.5.18:8080/EStore/"+pro.imgurl);
...
//暂时停止
    ...
    private void getProduct() {
        ...
        String url = HttpUrlUtils.HTTP_URL + "getmypublishservlet?email=491830643@qq.com";//访问网络的url
        ...
        x.http().get(requestParams, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                if(adapter==null){
                    ...
                    adapter=new myAdapter();
                    lv_publishlv.setAdapter(adapter);
                }else{
                    Log.e("PublishEStoreFragment","adapter!=null");
