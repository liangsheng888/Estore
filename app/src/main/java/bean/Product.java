...
public class Product implements Serializable{
	...
	public void setAuct_name(String auctName) {
		auct_name = auctName;
	}
	...
	public void setXingCount(int xingCount) {
	...
	public Product(Integer userId, String name, String category,
	...
	public Product(String name, String category, double estoreprice,
	...
	public Product(String name, String category, double marketprice,
...
//拍卖
	...
	public Product(String proName, String category2, double parseDouble,
	...
	public String toString() {
		return "Product [auct_begin=" + auct_begin + ", auct_bid_price="
				+ auct_bid_price + ", auct_end=" + auct_end
				+ ", auct_minprice=" + auct_minprice + ", auct_name="
				+ auct_name + ", auct_time=" + auct_time + ", category="
				...
				+ shcoolname + ", time=" + time + ", userNick=" + userNick
				+ ", userPhoto=" + userPhoto + ", user_id=" + user_id
				+ ", xingCount=" + xingCount + ", youfei=" + youfei + "]";
	}
